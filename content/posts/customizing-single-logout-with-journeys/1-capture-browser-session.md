...
![Tenant Settings](/img/customizing-single-logout-with-journeys/1-tenant-settings.png)
![Tenant Cookie](/img/customizing-single-logout-with-journeys/1-tenant-cookie.png)
...
![ESVs in Tenant Settings](/img/customizing-single-logout-with-journeys/1-esvs.png)
![Adding a Secret](/img/customizing-single-logout-with-journeys/1-add-secret.png)
![Setting the Secret Value](/img/customizing-single-logout-with-journeys/1-set-secret-value.png)
...
![Getting the Session Journey Example](/img/customizing-single-logout-with-journeys/1-session-journey.png)
...
![Screenshot of the User's Cookie in Devtools](/img/customizing-single-logout-with-journeys/1-session-cookie-devtools.png)
...
![Screenshot of the User's Cookie in User State](/img/customizing-single-logout-with-journeys/1-session-cookie-state.png)
...
![Screenshot of no cookies found in User State](/img/customizing-single-logout-with-journeys/1-session-no-cookie-state.png)
