...
![Screenshot of No External Sessions Logout Journey](/img/customizing-single-logout-with-journeys/3-no-external-sessions-journey.png)

_Logging Out the User in PingOne AIC - No External Sessions_

Or if you added the REST call Journey, like this:

![Screenshot of External Sessions Logout Journey](/img/customizing-single-logout-with-journeys/3-external-sessions-journey.png)
...
![Screenshot of External Sessions Logout Journey with Testing](/img/customizing-single-logout-with-journeys/3-external-sessions-journey-test.png)
...
![Screenshot of the Logged-In User](/img/customizing-single-logout-with-journeys/3-logged-in-user.png)
![Screenshot of the Logged-In User's Active Session](/img/customizing-single-logout-with-journeys/3-logged-in-user-session.png)
...
![Screenshot of the login screen](/img/customizing-single-logout-with-journeys/3-login-screen.png)
![Screenshot of no sessions](/img/customizing-single-logout-with-journeys/3-no-session.png)
