...
![Identify Existing User Node Details](/img/customizing-single-logout-with-journeys/2-id-existing-user-details.png)
...
![Screenshot of the Terminate Session Journey](/img/customizing-single-logout-with-journeys/2-terminate-session-journey.png)
...
![Screenshot of the User Details Page](/img/customizing-single-logout-with-journeys/2-user-details-page.png)
![Screenshot of the phrase "exampleSSOToken" added to the User's Generic Unindexed String 2](/img/customizing-single-logout-with-journeys/2-updating-frUnindexedString.png)
...
![Screenshot of the termination response in state](/img/customizing-single-logout-with-journeys/2-termination-response.png)
...
![Screenshot of no user found in state](/img/customizing-single-logout-with-journeys/2-no-user-found.png)
