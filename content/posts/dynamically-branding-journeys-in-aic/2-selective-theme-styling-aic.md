...
![A screenshot of diabling the logo in the "Global" hosted page](/img/dynamically-branding-journeys-in-aic/2-hide-logo.png)
...
![A screenshot pointing to the "Script Tags" section of the Hosted Page editor where the script has been added and enabled](/img/dynamically-branding-journeys-in-aic/2-script-tag.png)
...
![A screenshot of the default "parent" logo showing up in the Hosted Page](/img/dynamically-branding-journeys-in-aic/2-script-tag-test.png)
...
![A screenshot of the 'globalRegistration' email switched to the advanced editor](/img/dynamically-branding-journeys-in-aic/2-global-registration-email.png)
...
![A screenshot of the 'globalRegistration' email sent to the user](/img/dynamically-branding-journeys-in-aic/2-global-registration-email-sent.png)
...
![A screenshot of the 'Theme Customization' Object Attribute](/img/dynamically-branding-journeys-in-aic/2-theme-customization.png)
...
![A screenshot of the 'Theme Customization' attributes within the "Example" organization](/img/dynamically-branding-journeys-in-aic/2-theme-customization-org.png)
...
![The Simplified Login Journey inside the Journey Editor](/img/dynamically-branding-journeys-in-aic/1-basicLogin.png)
...
![A screenshot of the 'Set Theme Styling' Scripted Decision Node within the Page Node of the example Journey](/img/dynamically-branding-journeys-in-aic/2-set-styling-journey.png)
...
![A screenshot of the example Journey including the "Get Org ID by Query Parameter" Script](/img/dynamically-branding-journeys-in-aic/2-set-styling-journey-complete.png)
...
![A screenshot of example values being added to the "Example" Organization](/img/dynamically-branding-journeys-in-aic/2-setting-theme-org.png)
...
![A screenshot of the Journey's Hosted Page taking the customizations set on the Organization](/img/dynamically-branding-journeys-in-aic/2-setting-theme-display.png)
...
![A screenshot of the complete set theme styling by hosted page and email journey](/img/dynamically-branding-journeys-in-aic/2-set-styling-email-journey-complete.png)
...
![A screenshot of the default global hosted page](/img/dynamically-branding-journeys-in-aic/2-global-theme.png)  
![A screenshot of the default global hosted page displaying a suspend node](/img/dynamically-branding-journeys-in-aic/2-global-theme-suspend.png) 
![A screenshot of the default global email template sent](/img/dynamically-branding-journeys-in-aic/2-global-theme-email.png)
...
![A screenshot of the stylized email template sent](/img/dynamically-branding-journeys-in-aic/2-custom-theme-email.png)
