...
![Screenshot of the Failure URL Node](/img/customizing-single-logout-with-journeys/4-failure-url-node.png)
...
![Screenshot of Dynamic Redirect Journey](/img/customizing-single-logout-with-journeys/4-dynamic-redirect-journey.png)
...
![Screenshot of Test User](/img/customizing-single-logout-with-journeys/2-user-details-page.png)
![Screenshot of url added to Generic Unindexed String 3](/img/customizing-single-logout-with-journeys/4-test-user-url.png)
...
![Screenshot of a redirect to ForgeRock.com](/img/customizing-single-logout-with-journeys/4-redirect-result.png)
...
![Screenshot of Organization Details](/img/customizing-single-logout-with-journeys/4-test-org-details.png)
![Screenshot of test user added to organization](/img/customizing-single-logout-with-journeys/4-test-user-org-membership.png)
...
![Screenshot of a redirect to pingidentity.com](/img/customizing-single-logout-with-journeys/4-redirect-result-org.png)
