...
![The Theme Overrides Object Attribute](/img/dynamically-branding-journeys-in-aic/1-themeOverrides.png)
...
![The Theme Overrides Object inside the "Example" Organization](/img/dynamically-branding-journeys-in-aic/1-themeOverridesEditor.png)
...
![The Simplified Login Journey Rendered in Preview within a Browser Window](/img/dynamically-branding-journeys-in-aic/1-basicLoginPreview.png)
...
![A screenshot of the dynamic hosted pages journey](/img/dynamically-branding-journeys-in-aic/1-dynamic-hosted-pages-journey.png)
...
![A screenshot of the rendered "Contrast" Hosted Page theme](/img/dynamically-branding-journeys-in-aic/1-contrast-fallback.png)
...
![A screenshot of the "Highlander" Theme being added to the "Example" Organization](/img/dynamically-branding-journeys-in-aic/1-setting-highlander.png)
...
![A screenshot of the Journey changing to the Highlander Hosted Page theme](/img/dynamically-branding-journeys-in-aic/1-highlander-set.png)
...
![A screenshot of the beginning part of the Journey containing both the Set Hosted Page and Set Email Scripted Nodes](/img/dynamically-branding-journeys-in-aic/1-dynamic-emails-journey-start.png)
...
![A screenshot of the entire Journey containing both the Set Hosted Page and Set Email Scripted Nodes](/img/dynamically-branding-journeys-in-aic/1-dynamic-emails-journey-complete.png)
...
![A screenshot of the default "Contrast" Hosted Page theme](/img/dynamically-branding-journeys-in-aic/1-contrast-theme-testing.png)
![A screenshot of the default email suspend node page with "Contrast" theme](/img/dynamically-branding-journeys-in-aic/1-contrast-theme-testing-sent.png)
![A screenshot of the default "registration" email in a mail viewer](/img/dynamically-branding-journeys-in-aic/1-default-registration-email.png)
...
![A screenshot of setting the Verification Email Template Name to "forgottenUsername"](/img/dynamically-branding-journeys-in-aic/1-setting-email-template.png)

_Overriding the Email Template_

Re-running your Journey, you’ll see that the email has changed!

![A screenshot of the "forgottenUsername" in an email browser](/img/dynamically-branding-journeys-in-aic/1-viewing-email-template.png)
